...
################################################################
#################combine flickr and governance##################
################################################################

library(countrycode)

# convert flickr country names into ISOcodes
photos_PA$ISO3 <- countrycode(photos_PA$country, "country.name", "iso3c")
# Warning message:
#   In countrycode(photos_PA$country, "country.name", "iso3c") :
#   Some values were not matched unambiguously: Indian Ocean Territories, Kosovo, Saint Martin

# manually look for ISO codes and change them
photos_PA$ISO3[which(photos_PA$country == "Indian Ocean Territories")] <- "IOT"

photos_PA$ISO3[which(photos_PA$country == "Kosovo")] <- "XKX"

photos_PA$ISO3[which(photos_PA$country == "Saint Martin")] <- "MAF"
